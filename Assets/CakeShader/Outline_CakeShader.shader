...
// Creates a consistent, scalable outline by encoding vert normals in the mesh's colour data.
//
// Based on this shader by Shrimpey. Thanks!
// https://github.com/Shrimpey/Outlined-Diffuse-Shader-Fixed

// Upgrade NOTE: replaced 'mul(UNITY_MATRIX_MVP,*)' with 'UnityObjectToClipPos(*)'

Shader "Outlined/CakeShader" {
	Properties {
